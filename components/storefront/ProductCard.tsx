...
export function ProductCard({
  ...
  return (
    <Link href={`/products/${slug}`} className="block">
      <div className="overflow-hidden border bg-white rounded-xl hover:border-primary transition-all duration-200 cursor-pointer h-full flex flex-col group">
        ...
        <CardContent className="flex-1 p-2 sm:p-3 md:p-4 flex flex-col">
          <h3 className="font-semibold text-xs sm:text-sm md:text-base text-black mb-1 sm:mb-2 line-clamp-2">{name}</h3>
          ...
          <Button
            ...
            className="w-full bg-primary hover:bg-primary/90 text-white mt-auto h-9 sm:h-10 md:h-12 text-xs sm:text-sm md:text-base font-semibold"
            size="sm"
          >
